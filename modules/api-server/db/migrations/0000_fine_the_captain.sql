...
CREATE TYPE "api-server"."game_status" AS ENUM('waiting', 'playing', 'finished');--> statement-breakpoint
CREATE TYPE "api-server"."log_status" AS ENUM('pending', 'processed', 'failed');--> statement-breakpoint
CREATE TYPE "api-server"."room_status" AS ENUM('waiting', 'playing', 'finished');--> statement-breakpoint
